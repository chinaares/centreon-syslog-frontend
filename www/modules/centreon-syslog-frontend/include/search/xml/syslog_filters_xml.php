 ...
 */
	...
	echo "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>";
 	...
 	echo "</headers>";
 	echo "<exports>";
 	echo "<export>"._("Export :")."</export>";
 	echo "<link url=\"javascript:ajax_generateCSV_XML('CSV')\" src=\"./modules/centreon-syslog-frontend/img/office_excel.png\" alt=\"export CSV\" />";
 	echo "<link url=\"javascript:ajax_generateCSV_XML('XML')\" src=\"./modules/centreon-syslog-frontend/img/xml.png\" alt=\"export XML\" />";
 	echo "<link url=\"javascript:ajax_generateODT('ODT')\" src=\"./modules/centreon-syslog-frontend/img/openoffice_writer.gif\" alt=\"export ODT\" />";
 	echo "</exports>";
 	...
 	echo "<from>"._("From: ")."</from>";
 	$StarDate = time();
 	echo "<StartDate>".date("m/d/Y", $StarDate)."</StartDate>";
 	echo "<StartTime>".(Date("H")-1).":".Date("i")."</StartTime>";
 	echo "<to>"._("  To: ")."</to>";
 	$EndDate = time();
 	echo "<EndDate>".date("m/d/Y", $EndDate)."</EndDate>";
 	echo "<EndTime>".Date("H:i")."</EndTime>";
